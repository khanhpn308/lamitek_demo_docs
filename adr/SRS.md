...
* **NFR1 (Độ trễ - Latency):** Độ trễ End-to-End từ lúc cảm biến thay đổi trạng thái đến khi hiển thị trên giao diện web phải < 500ms trong điều kiện mạng tiêu chuẩn.
